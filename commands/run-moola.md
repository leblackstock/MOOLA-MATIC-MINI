...
Include estimated measurements and packaging-weight estimates in the initial JSON output. Shipping weight and packaging weight should be estimated by the AI during the Value phase, not recalculated by the UI.
